...
center = np.array([320,480,1], np.float32) #289
invisible_distance = 298
...
def calculate(tf_center, tf_object_center):
	distance = tf_center - tf_object_center#tf_center - tf_object_center
...
if __name__ == '__main__':
	...
	while not rospy.is_shutdown(): #cap.isOpened()
		...
		# print('class name', box_class)
  		...
  		cv2.circle(img_transformed, (450, 650), 5, (255,0,0), -1)
		cv2.circle(img_transformed, (up_left[0], up_left[1]), 5, (255,0,0), -1)
