...
if __name__ == '__main__':
	...
	out = cv2.VideoWriter('/home/foscar/ISCC_2021/src/vision_distance/src/10-22/inter_{}-{}-{}-{}-{}.avi'.format(now.year,now.month, now.day, now.hour, now.minute), cv2.VideoWriter_fourcc(*'MJPG'),30,(640,480))
	out3 = cv2.VideoWriter('/home/foscar/ISCC_2021/src/vision_distance/src/10-22/warp_{}-{}-{}-{}-{}.avi'.format(now.year,now.month, now.day, now.hour, now.minute), cv2.VideoWriter_fourcc(*'MJPG'),30,(1000,850))
