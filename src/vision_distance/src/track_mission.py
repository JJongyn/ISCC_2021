...
center = np.array([289,480,1], np.float32)
...
def drive(pid):
	  ...
	  drive_value.steering = -pid * 3 # -pid * 1.25
...
if __name__ == '__main__':
	...
	out = cv2.VideoWriter('/home/foscar/ISCC_2021/src/vision_distance/src/10-22/origin_{}-{}-{}-{}-{}.avi'.format(now.year,now.month, now.day, now.hour, now.minute), cv2.VideoWriter_fourcc(*'MJPG'),30,(640,480))
	...
	out4 = cv2.VideoWriter('/home/foscar/ISCC_2021/src/vision_distance/src/10-22/out_img_{}-{}-{}-{}-{}.avi'.format(now.year,now.month, now.day, now.hour, now.minute), cv2.VideoWriter_fourcc(*'MJPG'),30,(1000,850))
	out5 = cv2.VideoWriter('/home/foscar/ISCC_2021/src/vision_distance/src/10-22/yellow_img_{}-{}-{}-{}-{}.avi'.format(now.year,now.month, now.day, now.hour, now.minute), cv2.VideoWriter_fourcc(*'MJPG'),30,(1000,850))
